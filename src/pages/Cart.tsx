...
const Cart = () => {
  ...
  const { items, totalItems, totalPrice, restaurantName, clearCart } =
    useCart();
  ...
  const deliveryFee =
    deliveryMethod === "pickup" ? 0 : selectedArea?.fee || 3.99;
  const taxAmount = totalPrice * 0.08;
  const totalAmount =
    totalPrice + (deliveryMethod === "delivery" ? deliveryFee : 0) + taxAmount;
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="bg-brand-charcoal py-10 text-brand-cream">
        <div className="container">
          <h1 className="text-brand-cream">Your Cart</h1>
        </div>
      </div>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span>{formatNaira(deliveryMethod === "pickup" ? 0 : deliveryFee)}</span>
                    </div>
