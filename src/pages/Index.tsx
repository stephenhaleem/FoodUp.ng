...
// Featured categories
const categories = [
  { id: 'burgers', name: 'Burgers', image: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=80' },
  { id: 'pizza', name: 'Pizza', image: 'https://images.unsplash.com/photo-1574071318508-1cdbab80d002?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=80' },
  { id: 'sushi', name: 'Sushi', image: 'https://images.unsplash.com/photo-1579871494447-9811cf80d66c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=80' },
  { id: 'healthy', name: 'Healthy', image: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=80' },
];
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="font-semibold text-lg mb-2">Choose a Restaurant</h3>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="font-semibold text-lg mb-2">Enjoy Your Delivery</h3>
              <p className="text-muted-foreground">
                Place your order and wait for your food to be delivered to your doorstep
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Link to="/auth?mode=signup">
              <Button 
                size="lg" 
                className="bg-white text-brand-orange hover:bg-white/90 hover:text-brand-orange"
              >
                Sign Up Now
              </Button>
            </Link>
