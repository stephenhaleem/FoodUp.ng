    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 container py-16">
        <div className="max-w-lg mx-auto text-center">
          {isPending ? (
            <Clock className="w-20 h-20 text-brand-chili mx-auto mb-6" />
          ) : (
          ...
          {isPending && (
            <div className="mb-8 p-6 bg-muted/30 rounded-lg text-left">
              ...
              <ol className="list-decimal ml-5 space-y-2">
                ...
                <li>
                  Include your reference number in the payment description.
                </li>
                <li>
                  Your order will be processed once payment is verified (usually
                  within 24 hours).
                </li>
              </ol>
            </div>
